...
<head>
    ...
    window.onload = function() {
        var searchvalue = window.opener.document.getElementById('approve').value.length;
        var table = document.getElementById("approve_table");
        ...
        if (rowCount == 1 && searchvalue > 0) {
            ...
            axios.post('https://webapi.vastar.com.tw/erpapi/api/Staff/List', {
                    ...
                    Staff_No: '',
                    Name: '',
                    FuzzySearch: window.opener.document.getElementById('approve').value
...
<body bgcolor="#E0E0E0">
    ...
    <center>
        <table id="approve_table" border="1" rules="all" cellpadding="5" cellspacing="50" style=" font-size:14px; border: 0.5px solid ; 
           border-collapse: collapse; width: 790px; ">
            ...
            if (@$_POST['action'] == "查詢") {
                ...
                foreach ($data as $value) { {
                        ...
                        echo "<td  align='center'>" . $value["Staff_No"] .  "</td>";
        ...
        $(function() {
            ...
            //     window.opener.document.getElementById('approve').value = name;
            //     window.close();
