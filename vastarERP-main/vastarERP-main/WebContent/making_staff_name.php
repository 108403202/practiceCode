...
<head>
    ...
    <script type='text/javascript'>
        window.onload = function() {
            var searchvalue = window.opener.document.getElementById('making_name').value.length;
            var table = document.getElementById("making_staff_table");
            ...
            if (rowCount == 1 && searchvalue > 0) {
                ...
                axios.post('https://webapi.vastar.com.tw/erpapi/api/Staff/List', {
                        ...
                        Staff_No: '',
                        Name: '',
                        FuzzySearch: window.opener.document.getElementById('making_name').value
                        ...
                        if (response.data[0]["Result"] == 0) {
                            for (var i = 0; i < response.data.length; i++) {
                                ...
                                element.addEventListener('click', function handleClick(event) {
                                    ...
                                    var table = document.getElementById('making_staff_table');
                                    window.opener.document.getElementById('making_name').value = table.rows[
...
<body bgcolor="#E0E0E0">
    ...
    <center>
        <table id="making_staff_table" border="1" rules="all" cellpadding="5" cellspacing="50" style=" font-size:14px; border: 0.5px solid ; 
            ...
            $(function() {
                ...
                el.forEach(function(button) {
                    button.addEventListener('click', function() {
                        ...
                        window.opener.document.getElementById('making_name').value = table.rows[
                            index].cells[2].innerHTML;
                        // 將製單人員代號儲存到localStorage
                        localStorage.setItem('Create_No', table.rows[index].cells[1].innerHTML);
                        window.close();
                    });
                })
                ...
                //     window.opener.document.getElementById('making_name').value = name;
                //     window.close();
