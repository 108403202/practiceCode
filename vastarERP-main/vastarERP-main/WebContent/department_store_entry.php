      ...
      <div class="container">
        ...
        <div class="customer-info">
          <div class="input-box">
            ...
            <input type="button" name="purchaser_name_button" class="query-btn" value="查詢" onclick="window.open('purchaser_name.php',config='height=300,width=500',target='_self');" />
          </div>
          <div class="input-box">
            <span class="info">連絡電話</span>
            <input type="text" name="purchaser_phone_number" id="purchasephoneid" placeholder="0912345678" required>
            <input type="button" name="purchaser_phone_number_button" class="query-btn" value="查詢" onclick="window.open('purchaser_name.php',config='height=300,width=500',target='_self');">
          </div>
          <div class="input-box">
            <span class="info">收貨人</span>
            <input type="text" name="receiver_name" id="receivenameid" placeholder="陳小明" required>
            <input type="button" name="receiver_name_button" class="query-btn" value="查詢" onclick="window.open('receiver_name.php',config='height=300,width=500',target='_self');">
          </div>
        </div>
        ...
        <div class="sales-info">
          <div class="input-box">
            ...
            <input type="button" name="place_sale_button" class="query-btn" value="查詢" onclick="window.open('place_sale.php',config='height=300,width=500',target='_self');">
          </div>
          <div class="input-box">
            <span class="info">銷售人員</span>
            <input type="text" id="seller" placeholder="陳瑞彬" required>
            <input type="button" name="seller_name_button" class="query-btn" value="查詢" onclick="window.open('seller_name.php',config='height=300,width=500',target='_self');" />
          </div>
          <div class="input-box">
            <span class="info">製單人員</span>
            <input type="text" id='making_name' placeholder="陳瑞彬" required>
            <input type="button" class="query-btn" value="查詢" onclick="window.open('making_staff_name.php',config='height=300,width=500',target='_self');">
          </div>
        </div>
        ...
        <div class="sales-date">
          ...
          <div class="select">
            <select name="account_type_select" onChange="location = this.options[this.selectedIndex].value;">
      ...
      <div class="footer-form">
        ...
        <div class="total-info">
          <div class="input-box">
            ...
            <input type="text" placeholder="90"  id="lumpSum" disabled>
          </div>
          <div class="input-box">
            <span class="info">折扣金額</span>
            <input type="text" placeholder="50" class="discount_calculate" id='discount_amount'>
          </div>
          <div class="input-box">
            <span class="info">折扣%數</span>
            <input type="text" placeholder="87%"  class="discount_calculate" id='discount_percent'>
          </div>
          <div class="input-box">
            <input type="button" value="預購總金額" class="sales-summury" onclick="window.open('pre_sales_depart_entry.html',config='height=300,width=500',target='_self');">
    ...
    <div class="somebtn">
      <div class="tool-box">
        ...
        <div class="check-box check1">
          ...
          <input type="button" class="query-btn" value="查詢" onclick="window.open('document_review.php',config='height=300,width=500',target='_self');">
        </div>
        <div class="check-box check2">
          <input type="button" class="approved-btn" value="核准">
          <input type="text" id='approve' placeholder="name1" required>
          <input type="button" class="query-btn" value="查詢" onclick="window.open('approve.php',config='height=300,width=500',target='_self');">
        </div>
        <!-- 掛載, 新增, 刪除, 下一筆-->
        <div class="check-box">
