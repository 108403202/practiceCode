...
<head>
    ...
    window.onload = function() {
        var searchvalue = window.opener.document.getElementById('review').value.length;
        ...
        if (rowCount == 1 && searchvalue > 0) {
            ...
            axios.post('https://webapi.vastar.com.tw/erpapi/api/Staff/List', {
                    ...
                    Staff_No: '',
                    Name: '',
                    FuzzySearch: window.opener.document.getElementById('review').value
                    ...
                    if (response.data[0]["Result"] == 0) {
                        for (var i = 0; i < response.data.length; i++) {
                            ...
                            element.addEventListener('click', function handleClick(event) {
                                ...
                                var table = document.getElementById('receiver_data_table');
                                window.opener.document.getElementById('review').value = table.rows[
...
<body bgcolor="#E0E0E0">
    ...
    <center>
        ...
        $(function() {
            ...
            //     window.opener.document.getElementById('review').value = name;
            //     window.close();
